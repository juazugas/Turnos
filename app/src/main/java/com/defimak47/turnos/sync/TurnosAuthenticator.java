...
/**
 * Manages authentication to the online resource for TurnOS.
 ...
 */
public class TurnosAuthenticator extends AbstractAccountAuthenticator {

    public TurnosAuthenticator (Context context) {
        super(context);
    }
